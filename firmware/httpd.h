...
#define MAX_TX_URI_SIZE	1460//(TX_RX_MAX_BUF_SIZE/2 - sizeof(char)*2)
...
void make_http_response_head(unsigned char *, char, uint32);				/* make response header */
