...
#define STATUS_OK  ((uint64)0x0000000000000000)    // Chip works well
#define STATUS_ERR ((uint64)0x4000000000000000)    // Chip not found
#define STATUS_PWR ((uint64)0x8000000000000000)    // Chip status error, has been powered down.
