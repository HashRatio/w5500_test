...
unsigned long ntohl(unsigned long netlong);		/* ntohl function converts a unsigned long from TCP/IP network order to host byte order (which is little-endian on Intel processors). */
